    ...
    <>
      ...
      <div className="my-6 flex flex-col items-center justify-center gap-x-12 xl:mb-12 xl:flex-row">
        ...
        <div className="mr-8 pt-6">
          ...
          <h2 className="prose text-center text-lg text-gray-600 dark:text-gray-400">
        ...
        <div className="my-12 mx-2 flex w-[300px] items-center justify-center sm:w-[400px] md:w-[550px]">
