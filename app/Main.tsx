    ...
    <>
      <div className="my-6 flex flex-col items-center gap-x-12 xl:mb-12 xl:flex-row">
        ...
        <div className="flex-1 pt-6">
          <h1 className="pb-6 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-6xl sm:leading-12 md:text-7xl md:leading-14">
            &lt;/Learn_Code&gt;
          </h1>
