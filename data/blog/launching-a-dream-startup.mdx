...
Now for the "eureka" moment. I don't think success happens overnight, just like I don't believe one can merely learn code in a single instance. Even foundational concepts must be trained and conditioned until they become second nature. However, the turning point came in the form of a story of unexpected origins.

As a self-published <a href="https://prodigalhouse.net/" target="_blank">author</a>, I enjoy crafting fiction using metaphors and parables to illustrate a message. So, I simply applied what I enjoyed best to learning how to code in Python. The concept was simple: <i>help a lost lion find his way home.</i> Simple, right? Like anything new, we can all be a little proud when asking for help.

Around the same time as this concept formulated, AI/LLMs (like ChatGPT and Gemini), were also gaining massive appeal. I explored these tools and found them beneficial for testing and debugging. What resulted were the early stages of <a href="/blog/code-of-the-lion" target="_blank">Code of the Lion</a>, a free code challenge designed to teach foundational Python concepts framed within a mini-game. Each iterative exercise helps Leo, a lost lion cub, navigate his way home through the jungle. After finishing the labs, you should walk away with a sense of accomplishment, all while having fun, similar to how children learn.
