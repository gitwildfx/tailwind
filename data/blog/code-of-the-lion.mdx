...
user_choice = input("Leo stands at a crossroads in the cave. Which direction will he go? (North, East, South, West) ").upper()

if user_choice in cave_exits:
  print("The exit to the", user_choice, "looks", cave_exits[user_choice])
else:
