...
<p className="mb-6 mt-4 text-md leading-7 text-gray-500 dark:text-gray-600">
► <em>For detailed explanations and visual guides, download the FREE guide below. </em>
</p>
