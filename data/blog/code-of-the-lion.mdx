...
## Introduction
Help Leo, a brave lion cub, navigate the jungle and find his way back to his pride! Use your <b>Python</b> skills to guide him through challenges and reunite him with his family.
...
Select the <b>deploy</b> button to launch your terminal environment. Download </b><em>"Code of the Lion"</em></b> eBook for more detailed instructions and visuals guides.
...
<div style={{ display: "flex", gap: "10px" }}>
  ...
  <a href="https://drive.google.com/file/d/1ZkEWCdh1_4ZD2UpkHE_kp7b5PBkIi6CY/view?usp=sharing" target="_blank">
    <img 
      ...
      alt="Download eBook"
      style={{ width: "156px", height: "33px", objectFit: "contain" }}
    />
  </a>
</div>
